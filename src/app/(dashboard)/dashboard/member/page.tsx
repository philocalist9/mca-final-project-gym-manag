  ...
  return (
    <div className="p-6">
      <div className="pb-5 border-b border-gray-200 dark:border-gray-700">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Member Dashboard</h1>
      ...
      <div className="mt-6 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <StatCard
          ...
          link="/dashboard/member/appointments"
          icon={
            <svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="mt-8 grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/dashboard/member/workouts" className="text-sm text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 dark:hover:text-indigo-300">
              View all
            </Link>
          </div>
          ...
          <div className="space-y-3">
            {upcomingWorkouts.length > 0 ? (
              ...
              <div className="text-center py-4">
                ...
                <Link href="/dashboard/member/workouts" className="mt-2 inline-block text-sm text-indigo-600 dark:text-indigo-400">
                  Schedule a workout
                </Link>
              </div>
            )}
        ...
        <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/dashboard/member/progress" className="text-sm text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 dark:hover:text-indigo-300">
              View all
            </Link>
          </div>
